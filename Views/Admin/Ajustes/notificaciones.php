...
<section class="container my-4" style="max-width:720px;">
  <h2 class="h4 mb-3">Preferencias de notificaciones (Admin)</h2>
  ...
  <form method="post" action="<?= BASE_URL ?>AdminAjustes/notificacionesPost">
    ...
    <div class="form-check form-switch mb-3">
      ...
      <div class="form-text">Te enviaremos un correo con acceso directo a la conversación.</div>
    </div>
